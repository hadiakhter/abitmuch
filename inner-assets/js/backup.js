...
// $(document).ready(function () {
//     $('.hoveron-this').hover(function () {
//         $(this).find('.second-drop-down').toggleClass('mil-active');
//         $(this).find('.second-open-list').toggleClass('mil-active');
//         console.log('Hovered over .hoveron-this element');
//     });
// });
// $(document).ready(function () {
...
//     var swiperinfi = new Swiper('.mil-infinite-show', {
//         speed: 5000,
//         autoplay: true,
//         autoplay: {
//             delay: 0,
